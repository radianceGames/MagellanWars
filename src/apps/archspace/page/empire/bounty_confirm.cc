...
bool
CPageEmpireBountyConfirm::handler(CPlayer *aPlayer)
{
	...
	ITEM("TARGET_PLAYER", TargetPlayerStr);

	ITEM("RESULT_MESSAGE", 
			GETTEXT("Are you sure you want to accept the bounty?<br>If you fail the empire will be displeased with you."));
